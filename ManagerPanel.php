...
<div class="container mt-4">
    <ul class="nav nav-tabs mb-3" role="tablist">
        <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#users">مدیریت کاربران</a></li>
        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#pending-users">کاربران تایید نشده</a></li>
        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#news">مدیریت اخبار</a></li>
        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#comments">مدیریت نظرات</a></li>
    </ul>
    ...
    <div class="tab-content">
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" class="d-flex gap-2">
                            ...
                            <button class="btn btn-primary btn-sm">تغییر نقش</button>
                        </form>
                    </td>
                    <td>
                        <form method="post">
        ...
        <div class="tab-pane fade" id="news">
            ...
            <div class="mb-3">
                <a href="addnews.php" class="btn btn-primary btn-lg">افزودن خبر جدید</a>
            </div>
